...
- **自动候选首批提升（2026-09-14）**：自动检索运行近一个月后首次产出高相关候选，人工审阅 8-24 ~ 9-11 共 19 篇后提升 6 篇至论文主表：结构光扫描仪重复性/误差预算（2608.30143）、sRGB 流模型噪声建模（2608.29038）、UCF UrbanTwin Sim2Real LiDAR 两篇（2609.07590 / 2609.07608，含 point-cloud realism 评测）、RealSimLoop（2609.09828）、CAP 学习式去噪（2609.11553）；另将 DARP 双臂 RGB-D-IR 数据集（2608.31002）加入 [datasets.md](datasets.md)。
- **第二批提升（2026-09-21）**：审阅 9-16 digest 的 3 篇候选，提升 1 篇——图基仿真 LiDAR 点云**结构保真度诊断**（arXiv:2609.16378，对应 P7 逼真度指标）；其余 2 篇（量子运动学、导盲犬交互）无关。9-17 ~ 9-20 无新候选。
