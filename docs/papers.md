...
| **Sensor-Informed Per-Point Covariance for Structured-Light 3D Imaging**（Tak & Hyun） | 预印本 2026-08（经每日自动检索入库） | [arXiv:2608.10888](https://arxiv.org/abs/2608.10888) | FPP 相位噪声经标定重建传播 → 传感器知情逐点协方差（对应开放问题 P2 误差传播） | ⭐⭐ |
